...
For the Youtube API key instructions see https://developers.google.com/youtube/v3/getting-started. This API key must be added to the script YT_guide_v2.py in line 38. 
The Anyscale API instructions are available on https://app.endpoints.anyscale.com/. This API key must be added to the script YT_guide_v2.py in line 28. 
